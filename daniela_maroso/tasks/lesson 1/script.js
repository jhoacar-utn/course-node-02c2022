...
/**
 * Funcion encargada de extraer la informacion del DOM para las monedas y los multiplicadores
 * @return object
 */
...
function setSolutionInDOM() {
    ...
    /**Como dato curioso si es una sola linea de codigo, no sera necesaria la apertura y cierre de llaves
     * ej: for(let index=0;index<algo;index++)
     *         console.log(index)   */
