//La solucion es ordenas los multiplicadores para que el mayor multiplicador coincida con la moneda mayor, el segundo mult. mayor con la 
//segunda moneda mayor, etc //

/** Esta funcion devuelve un orden correcto de multiplicadores pasado un array de numeros enteros 
 ...
 */
 function getCorrectMultipliers(coins, multipliers) {
    ...
    /** Ordenamos el array haciendo match del numero mas grande de la moneda con el numero mas grande, correspondiente al multiplicador*/
...
/** Esta funcion devuelve la suma de la multiplicacion de las monedas con su multiplicador
 * @param {number[]} coins
 * @param {number[]} multipliers
 * @return number
 */
...
/** Esta funcion devuelve las posiciones del primer vector que encuentra de los valores del segundo vector
