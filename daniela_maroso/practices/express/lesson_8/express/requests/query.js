...
/**
 * Si no usamos esta linea de codigo no tendremos acceso a la request.query con los datos quye vendran luego de '?' en la url
*/

app.use(express.urlencoded({ extended: false }));

/**
 * Al trabajar con la query de la url, no tenemos necesidad de controlar alguna ruta, porque sera informacion extra que podemos interpretar
 * Ejemplo:
...
app.get('/usuario', (request, response) => {
   ...
   *  Un caso de uso puede ser para seguir extrayendo todos los datos que hayan sido agregados
   */
