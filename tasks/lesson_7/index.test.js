...
describe("Operaciones aritmeticas", () => {
    ...
    describe("Operacion de Suma", () => {
        ...
        test("Deberia arrojar una excepcion si no cumple que es un numero sus parametros", () => {
            expect(() => sum("Hola", "2")).toThrow(new Error("Los parametros deben ser numeros"));
        })

        test("Deberia poder sumar tres o mas parametros", () => {
            expect(sum(1, 3, "6")).toBe(10);
        })

        test("Deberia sumar cadenas de texto o numeros con decimales", () => {
